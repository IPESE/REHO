...
if __name__ == '__main__':
    ...
    # EVs can be charged both in their district of residence and in the other optimized districts.
    ...
    for tr in districts:
        ...
        modal_split = pd.DataFrame({"min_D0": [0, 0, 0.4, 0.4], "max_D0": [0.1, 0.3, 0.7, 0.7], "min_D1": [0, 0.2, 0.4, 0.4], "max_D1": [0, 0.4, 0.7, 0.7]},
