...
EV_E_stored_plug_out[u,p,t] <= (EV_limit_ch*EV_capacity + EV_displacement_init[p])*Units_Use[u] * n_vehicles * EV_plugged_out[p,t];											#kWh

subject to EV_c6c{u in UnitsOfType['EV'],p in Period,t in Time[p]}:
EV_E_stored_plug_out[u,p,t] >= (EV_limit_di*EV_capacity + EV_displacement_init[p])*Units_Use[u] * n_vehicles * EV_plugged_out[p,t];										#kWh
																			#-
