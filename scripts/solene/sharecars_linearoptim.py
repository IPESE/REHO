...
if __name__ == '__main__':
    ...
    for s, share_cars in zip(range(n_samples), samples):
        try:
            ...
            mob_param = mobility_demand_from_WP1data_modes(36.8,80,3,0.02,share_cars=share_cars,share_EV_infleet=1)
    ...
    vars()[f"reho_{districts[0]}"].save_results(format=['pickle'], filename=f'sharecars_lin_{date}')
