...
subject to ELH_energy_balance{u in UnitsOfType['ElectricalHeater'] ,p in Period,t in Time[p]}:
Units_supply['Heat',u,p,t] = ELH_efficiency_max[u]*Units_demand["Electricity",u,p,t];

subject to ELH_district_c1{u in UnitsOfType['ElectricalHeater'] ,p in Period,t in Time[p]}:
