...
def df_sankey(df_Results, label='EN_long', color='ColorPastel', precision=2, units='MWh', display_label_value=True, scaling_factor=1):
    ...
    services = ['SH','DHW','Cooling','rSOC_heat']
    ...
    non_common_layers = {
        ...
        'Mobility': {
            'flows': [
                ...
                #('Electrical_consumption', 'Total_EV_fleet', 'EV_district', 'Demand_MWh', False, None, 0, 1),
                #('Total_EV_fleet', 'Electrical_consumption', 'EV_district', 'Supply_MWh', False, None, 0, 1),
                ('Total_EV_fleet', 'Mobility', 'EV_district', 'Supply_MWh', False, None, 0, 1 / 9.37),
                #('Electrical_consumption', 'Total_EV_fleet', 'EV_charger_district', 'Demand_MWh', False, None, 0, 1),
                #('Total_EV_fleet', 'Electrical_consumption', 'EV_charger_district', 'Supply_MWh', False, None, 0, 1),
    ...
    df_label, df_stv = apply_molecule_flows(df_annuals, df_label, df_stv, non_common_layers)
...
def apply_molecule_flows(df_annuals, df_label, df_stv, molecule_flows):
