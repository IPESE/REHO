...
if __name__ == '__main__':
    ...
    reader.establish_connection('Suisse-old')   # connect to QBuildings database
    ...
    grids = structure.initialize_grids()    # initialize grid parameters such as energy tariffs. More information is available in example 2b
