...
```{image} ../images/logos/logo-reho-black.png
:align: center
:class: only-light
```

```{image} ../images/logos/logo-reho-white.png
:align: center
:class: only-dark
```
...
REHO embeds a coupling with [QBuildings](https://qbuildings.epfl.ch/),
...
The *ActorsModel* extension of REHO enables to integrate and model the different stakeholders of an energy community.
