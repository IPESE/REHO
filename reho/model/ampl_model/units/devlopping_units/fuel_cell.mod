...
subject to FC_energy_balance{u in UnitsOfType['FuelCell'], p in Period,t in Time[p]}:
Units_supply['Electricity',u,p,t] = FC_conv_eff[u]*Units_demand['Hydrogen',u,p,t];
...
Units_demand['Hydrogen',u,p,t]*(FC_max_overall_efficiency[u]-FC_conv_eff[u]) = sum{sq in ServicesOfStream[st]} Streams_Q[sq,st,p,t];;

# Power limitation
subject to FC_PL_c1{u in UnitsOfType['FuelCell'],p in Period, t in Time[p]}:
Units_supply['Electricity',u,p,t] <= Units_Mult[u]*FC_power_limit_in_basis[u];
