...
subject to Bikes_cb1{u in UnitsOfType["Bike"]}:
n_bikes <= max_n_bikes;

subject to Bikes_cb2{u in UnitsOfType["Bike"]}:
n_bikes = Units_Mult[u];

subject to Bikes_maxshare{u in UnitsOfType['Bike'],p in Period, t in Time[p]}:
Units_supply['Mobility',u,p,t] = share_bike * Domestic_energy['Mobility',p,t]