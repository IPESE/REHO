...
===========================================================
The renovation method consists in a list of renovation option. Each option contains building elements to renovate. The order doesn't matter. The buildings elements are window, facade, roof and footprint.
...
This option uses the values in ``infrastructure/U_values.csv`` instead of the U values from QBuilding.
...
Investigate the boundaries of decision-makers in a district energy system and how they influence the optimal design of the system.

Including building upfront cost
====================================
Landlords may consider the upfront cost of building by charging a fixed cold rent from tenants. Tenants' expenses thus include both the energy cost and the cold rent.
