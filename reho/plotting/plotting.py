...
def plot_EVs(results, era, label='EN_long', color='ColorPastel', save_fig=False, save_name=None):
...
def plot_load_duration_curve(results, ids, save_fig = False, label='EN_long', color='ColorPastel', save_name=None):
