...
if __name__ == '__main__':
    ...
    qbuildings_data = reader.read_db(15154, nb_buildings=6)

    # Select clustering options for weather data
    cluster = {'Location': 'Zurich', 'Attributes': ['T', 'I', 'W'], 'Periods': 10, 'PeriodDuration': 24}
    ...
    # Save results
    reho.save_results(format=['save_all', 'pickle'], filename='ScenarioRef_15154')
