...
Development of REHO was carried out within the Industrial Process and Energy Systems Engineering research group (IPESE), EPFL. The authors acknowledge the financial support from the Services Industriels de Genève (SIG), Switzerland, and from the Swiss Federal Office of Energy (SFOE).
