...
subject to MTR_Usable_heat_computation{u in UnitsOfType['Methanator'],p in Period,t in Time[p]}:
    Units_demand['Hydrogen',u,p,t]*(MTR_therm_eff_high_T[u] + MTR_therm_eff_mid_T[u]) >= Units_supply['Heat',u,p,t];
