...
def plot_daily_profiles(df_Results, units_to_plot, period, style='plotly', label='EN_long', color='ColorPastel',
    ...
    _lang = 'FR' if label.startswith('FR') else 'EN'
    _t = _TRANSLATIONS[_lang]
    x_day = list(range(1, len(import_day["Electricity"]) + 1))
    obj_x = _t['time_h']
    obj_y = _t['kwh']
...
def plot_combined_profiles(df_Results, units_to_plot, label='EN_long', color='ColorPastel', resolution='weekly',
    ...
    daily_figs = {
        season: plot_daily_profiles(df_Results, units_to_plot, period=period, style='plotly',
