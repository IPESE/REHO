...
param WOOD_Stove_install{u in UnitsOfType['WOOD_Stove']} default 0;
...
# constrain to enforce the installation of the wood stove
subject to enforce_WOOD_Stove{u in UnitsOfType['WOOD_Stove']: WOOD_Stove_install[u] >= 0}:
Units_Use[u] = WOOD_Stove_install[u];