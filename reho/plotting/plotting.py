...
def prepare_dfs(df_Economics, indexed_on='Scn_ID', neg=False, premium_version=None, additional_data={}, scaling_factor=1):
    """
...
def plot_performance(results, plot='costs', indexed_on='Scn_ID', label='EN_long', add_annotation=True, per_m2=False, additional_costs={}, additional_gwp={},
                     scc=0.177,
...
def plot_expenses(results, plot='costs', indexed_on='Scn_ID', label='EN_long', premium_version=None, per_m2=False, additional_costs={}, additional_gwp={},
                  ...
                  filename=None, export_format='html', scaling_factor=1, return_df=False):
    """
    Plot expenses based on REHO results.
...
def plot_sankey(df_Results, label='EN_long', color='ColorPastel', filename=None, export_format='html', scaling_factor=1, return_df=False):
    """
    Plot a Sankey plot based on the results DataFrame.
...
def plot_sunburst_eud(results, label='EN_long', filename=None, export_format='html', scaling_factor=1, return_df=False):
    """
    Plot a Sunburst for End Use Demand (EUD) based on REHO results, grouped by buildings' class.
...
def plot_unit_monthly(results, unit_to_plot, label='EN_short', filename=None, export_format='html'):
    """
    Generate a monthly bar plot showing the mean energy produced per hour and the installed power for a specific unit.
...
def plot_pareto(results, label='EN_long', color='ColorPastel', return_df=False):
    """
    Plot Pareto front based on REHO results.
   ...
   Returns
    ...
    df_performance = dict_to_df(results, 'df_Performance').loc[(slice(None), slice(None), 'Network'), ["Costs_op", "Costs_inv", "Costs_grid_connection", "Costs_rep", "GWP_op", "GWP_constr"]].reset_index(['Scn_ID', 'Hub'])
...
def plot_pareto_by_objectives(results, name_list=None, objectives=["CAPEX", "OPEX"], style='plotly', annotation="TOTEX",
                              annot_offset=0, legend=True, filename=None, export_format='png'):
    df_performance_dict = {}
