...
def generate_EV_plugged_out_profiles_district(cluster):
    ...
    #plot_EV_occupancy_profile(EV_plugged_out)
...
def generate_EV_plugged_out_profiles(cluster, n_houses=31):
    ...
    return EV_plugged_out


def plot_EV_occupancy_profile(EV_plugged_out):
    idx = list(range(1,25))
    fig, ax = plt.subplots(figsize=(10, 6))
    ax.fill_between(idx, EV_plugged_out[72:96]*100, color="royalblue", label="weekdays", alpha=0.3)
    ax.fill_between(idx, EV_plugged_out[96:120]*100, color="mediumseagreen", label="weekends", alpha=0.3)
    ax.plot(idx, EV_plugged_out[72:96]*100, color="royalblue", alpha=0.3)
    ax.plot(idx, EV_plugged_out[96:120]*100, color="mediumseagreen", alpha=0.3)
