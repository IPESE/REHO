...
param MTZ_heat_recovery_eff{u in UnitsOfType['Methanator']} >= 0 default 0.286;
...
param MTZ_elec_cons_15_bars{u in UnitsOfType['Methanator']} default 0.01; # Make use of high Pressure CO2 to entrain low P H2 (ejector) for a final pressure of ~15 bars
