...
param MTZ_conv_eff_basis{u in UnitsOfType['Methanizer']} >=0, <=1 default 0.832255725;
param MTZ_power_limit_in_basis{u in UnitsOfType['Methanizer']} >=0 default 1;
param MTZ_CO2_mol_h_per_kW_H2{u in UnitsOfType['Methanizer']} default 3.721349846; # from Aspen simulations (mol/h of CO2 for 1 kW H2 input)
param MTZ_elec_cons_7_bars{u in UnitsOfType['Methanizer']} default 0.01322; # from Aspen simulations (electrical input (up to 7 bars) Methanizer)
...
subject to MTZ_CH4_production{u in UnitsOfType['Methanizer'], p in Period,t in Time[p]}:
    Units_supply['Biogas',u,p,t] = MTZ_conv_eff_basis[u]*Units_demand['Hydrogen',u,p,t];

subject to MTZ_elec_consumption{u in UnitsOfType['Methanizer'], p in Period,t in Time[p]}:
