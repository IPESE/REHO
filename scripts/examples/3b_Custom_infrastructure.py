...
if __name__ == '__main__':
    ...
    grids = configuration.initialize_grids({'Electricity': {"Cost_supply_cst": 0.30, "Cost_demand_cst": 0.16},
    ...
    units = configuration.initialize_units(scenario, grids, building_data=path_to_custom_units)
